...
const DOCUMENTED_WORKSPACE_PATTERNS = [
  ...
  { pathPattern: /^packages\/agent-mcp$/, textPattern: /agent-mcp\// },
  ...
  { pathPattern: /^packages\/agent-file-authority$/, textPattern: /agent-file-authority/ },
  ...
  { pathPattern: /^packages\/agent-capability-pack$/, textPattern: /agent-capability-pack/ },
  { pathPattern: /^packages\/agent-product$/, textPattern: /agent-product/ },
  { pathPattern: /^packages\/pack-[^/]+$/, textPattern: /pack-\*/ },
  ...
  { pathPattern: /^packages\/agent-cli-web$/, textPattern: /agent-cli-web/ },
  ...
  { pathPattern: /^packages\/agent-remote-pairing$/, textPattern: /agent-remote-pairing/ },
