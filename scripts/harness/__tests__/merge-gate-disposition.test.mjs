...
function stubbedPath(prs) {
  ...
  writeFileSync(
    ...
    [
      ...
      '  // The hook reads the complete verdict list, then selects the newest entry itself.',
      '  // Returning only the newest object makes jq `length` count fields rather than verdicts.',
