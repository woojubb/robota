...
export const UNDOCUMENTED_EXPORT_ALLOWLIST = new Set([
  ...
  '@robota-sdk/agent-command#RemoteControlCommandSource',
  ...
  '@robota-sdk/agent-command#createRemoteControlCommandEntry',
  '@robota-sdk/agent-command#createRemoteControlCommandModule',
  ...
  '@robota-sdk/agent-command#executeRemoteControlCommand',
  ...
  '@robota-sdk/agent-core#createProviderFromConfig',
  ...
  '@robota-sdk/agent-core#normalizeProviderConfig',
