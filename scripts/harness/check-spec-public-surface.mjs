...
export const UNDOCUMENTED_EXPORT_ALLOWLIST = new Set([
  ...
  '@robota-sdk/agent-provider#ANTHROPIC_MODEL_LAST_VERIFIED_AT',
  '@robota-sdk/agent-provider#ANTHROPIC_MODEL_SOURCE_URL',
  '@robota-sdk/agent-provider#AnthropicProvider',
  '@robota-sdk/agent-provider#BytedanceProvider',
  '@robota-sdk/agent-provider#ConsolePayloadLogger',
  '@robota-sdk/agent-provider#DEEPSEEK_DEPRECATED_ALIAS_RETIREMENT_DATE',
  '@robota-sdk/agent-provider#DEEPSEEK_MODEL_CATALOG_SOURCE_URL',
  '@robota-sdk/agent-provider#DEEPSEEK_MODEL_LAST_VERIFIED_AT',
  '@robota-sdk/agent-provider#DEEPSEEK_MODEL_LIST_SOURCE_URL',
  '@robota-sdk/agent-provider#DEFAULT_ANTHROPIC_PROVIDER_API_KEY_ENV',
  '@robota-sdk/agent-provider#DEFAULT_ANTHROPIC_PROVIDER_API_KEY_REFERENCE',
  '@robota-sdk/agent-provider#DEFAULT_ANTHROPIC_PROVIDER_MODEL',
  '@robota-sdk/agent-provider#DEFAULT_DEEPSEEK_PROVIDER_API_KEY_ENV',
  '@robota-sdk/agent-provider#DEFAULT_DEEPSEEK_PROVIDER_API_KEY_REFERENCE',
  '@robota-sdk/agent-provider#DEFAULT_DEEPSEEK_PROVIDER_BASE_URL',
  '@robota-sdk/agent-provider#DEFAULT_DEEPSEEK_PROVIDER_MODEL',
  '@robota-sdk/agent-provider#DEFAULT_GEMINI_PROVIDER_API_KEY_ENV',
  '@robota-sdk/agent-provider#DEFAULT_GEMINI_PROVIDER_API_KEY_REFERENCE',
  '@robota-sdk/agent-provider#DEFAULT_GEMINI_PROVIDER_MODEL',
  '@robota-sdk/agent-provider#DEFAULT_GEMMA_PROVIDER_API_KEY',
  '@robota-sdk/agent-provider#DEFAULT_GEMMA_PROVIDER_BASE_URL',
  '@robota-sdk/agent-provider#DEFAULT_GEMMA_PROVIDER_MODEL',
  '@robota-sdk/agent-provider#DEFAULT_OPENAI_PROVIDER_API_KEY_REFERENCE',
  '@robota-sdk/agent-provider#DEFAULT_OPENAI_PROVIDER_MODEL',
  '@robota-sdk/agent-provider#DEFAULT_QWEN_PROVIDER_API_KEY_ENV',
  '@robota-sdk/agent-provider#DEFAULT_QWEN_PROVIDER_API_KEY_REFERENCE',
  '@robota-sdk/agent-provider#DEFAULT_QWEN_PROVIDER_BASE_URL',
  '@robota-sdk/agent-provider#DEFAULT_QWEN_PROVIDER_MODEL',
  '@robota-sdk/agent-provider#DEFAULT_QWEN_PROVIDER_RESPONSES_BASE_URL',
  '@robota-sdk/agent-provider#DeepSeekProvider',
  '@robota-sdk/agent-provider#FilePayloadLogger',
  '@robota-sdk/agent-provider#GEMINI_MODEL_LAST_VERIFIED_AT',
  '@robota-sdk/agent-provider#GEMINI_MODEL_SOURCE_URL',
  '@robota-sdk/agent-provider#GeminiProvider',
  '@robota-sdk/agent-provider#GemmaProvider',
  '@robota-sdk/agent-provider#GemmaReasoningProjector',
  '@robota-sdk/agent-provider#GemmaToolCallProjector',
  '@robota-sdk/agent-provider#GoogleProvider',
  '@robota-sdk/agent-provider#OpenAIConversationAdapter',
  '@robota-sdk/agent-provider#OpenAIProvider',
  '@robota-sdk/agent-provider#QWEN_MODEL_LAST_VERIFIED_AT',
  '@robota-sdk/agent-provider#QWEN_MODEL_SOURCE_URL',
  '@robota-sdk/agent-provider#QWEN_PROVIDER_BASE_URLS',
  '@robota-sdk/agent-provider#QWEN_PROVIDER_RESPONSES_BASE_URLS',
  '@robota-sdk/agent-provider#QwenProvider',
  '@robota-sdk/agent-provider#createAnthropicProvider',
  '@robota-sdk/agent-provider#createAnthropicProviderDefinition',
  '@robota-sdk/agent-provider#createDeepSeekProviderDefinition',
  '@robota-sdk/agent-provider#createDefaultProviderDefinitions',
  '@robota-sdk/agent-provider#createGeminiProviderDefinition',
  '@robota-sdk/agent-provider#createGemmaProviderDefinition',
  '@robota-sdk/agent-provider#createGemmaToolCallProjector',
  '@robota-sdk/agent-provider#createOpenAIProviderDefinition',
  '@robota-sdk/agent-provider#createQwenProviderDefinition',
  '@robota-sdk/agent-provider#projectGemmaReasoningText',
  '@robota-sdk/agent-provider#projectGemmaToolCallText',
  '@robota-sdk/agent-provider#refreshAnthropicModelCatalog',
  '@robota-sdk/agent-provider#refreshDeepSeekModelCatalog',
  '@robota-sdk/agent-provider#refreshGeminiModelCatalog',
  '@robota-sdk/agent-provider#refreshOpenAIModelCatalog',
  '@robota-sdk/agent-provider#refreshQwenModelCatalog',
