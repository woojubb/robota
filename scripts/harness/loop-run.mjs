...
export function main(
  ...
  switch (args.command) {
    ...
    default:
      throw new Error(
        `loop-run: unknown command \`${args.command ?? '(none)'}\`. Use open, expect, coverage, observe, recommendation-expect, recommendation-observe, pass-through, draft-finding, final-finding, foundational, reconcile-route, disposition, link, round, close, void or show.`,
      );
  }
}
