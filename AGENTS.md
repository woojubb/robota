...
**Execution cadence.** Small supplements are batched, not separately reviewed, recorded,
checkpointed, committed, or fully verified. [execution-cadence.md](.agents/rules/execution-cadence.md)
owns this invariant and its re-entry conditions; apply it before dispatching execution workflows.
