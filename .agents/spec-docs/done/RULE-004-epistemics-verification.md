...
Distilled from the Claude reference profile system prompt
(`.design/conduct-adoption/2026-06-18/_SOURCE-reference.md`: `### knowledge_cutoff` L156–165,
...
reference profile's consumer-chat "search the web before asserting changeable facts" maps onto a coding agent
...
## Gap Analysis (reference profile → coding agent vs current harness)

| reference profile principle (coding mapping)                                                                                                     | Already covered?                                                                                                                                             | Verdict                                   |
| -------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------- |
...
direction (reference profile wins on conflict if one arises; "mention cutoff only when relevant" per L460).
...
- 2026-06-18 — Source assessed: reference profile `knowledge_cutoff` (L156–165), `core_search_behaviors` /
