...
# RULE-001: Adopt Fable-5 as the agent-conduct authority (unlimited precedence)

## Problem

The user has decided to adopt the **Claude Fable-5 system prompt**
(`.design/fable5-adoption/2026-06-18/_SOURCE-fable5.md`) as the governing authority for agent
conduct in this repo. The explicit directive is **unlimited Fable-5 precedence: wherever any
Fable-5 principle conflicts with an existing harness rule, Fable-5 wins — across all areas.**
...
> the Claude Fable-5 conduct principles (see `.agents/rules/agent-conduct.md`) are authoritative.
> Where a Fable-5 conduct principle conflicts with any other harness rule or skill, **Fable-5
> takes precedence.** (Repo engineering invariants that Fable-5 does not address — build/test
> green, machine-parsed file structure — are not in conflict and remain in force; see each
> area's Implementation Risk.)

This sits in the existing precedence chain as: **user instructions > Fable-5 conduct > other
...
| -------- | -------------------------------------------------------- | -------------------------------------------------------- |
| RULE-002 | Communication & formatting                               | `.design/fable5-adoption/2026-06-18/01-communication.md` |
...
3. **The one hard conflict (from RULE-002):** Fable-5's "technical docs in prose, no
...
- **Import the whole Fable-5 doc verbatim** — rejected: ~46% is claude.ai tool schemas, ~40%
...
- 2026-06-18 — User escalated to unlimited Fable-5 precedence across all areas. Prior conservative
  RULE-001 withdrawn; repurposed as governance/meta. 5-area parallel analysis produced
  RULE-002..006 drafts + reports under `.design/fable5-adoption/2026-06-18/`.
