...
No runnable user-facing behaviour changes; verification evidence is recorded in the engineering test plan (TC-01 to TC-03).

**Reason:** No runnable user-facing behaviour changes; the engineering test plan records the observable
proof for the repository-only isolation seam.
