...
# RULE-006: Distill transferable operational / tool-use behavioral norms from the Fable-5 system prompt

## Problem

The user adopted the **Claude Fable-5 system prompt** as governing authority with **unlimited
Fable-5 precedence on conflict**. This draft covers **one area only: operational / tool-use
...
Fable-5 is a **consumer chat-product (claude.ai) prompt**. Its operational sections are tied to
...
## Gap Analysis (Fable-5 operational norms vs current harness)

| Fable-5 norm                                                                                                                                                     | Repo mapping                                                                                                                                                                                                               | Verdict                                                           |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------- |
| **N1** Check context before asking; if request is already specific, proceed and state assumptions inline; one question max; "A or B?" wants analysis not buttons | `operational.md` Option Proposal, `research.md` Recommendation Authority, `feedback_agent_decision_authority`, `feedback_never_ask_user_to_test` — mostly covered; "check context first + inline assumptions" not codified | **conflict→Fable-5** (more specific; wins) / largely **covered**  |
...
Net: **N2, N3 = NEW**; **N4, N6 = NEW (thin)**; N1/N5 = covered-but-reinforced (Fable-5 wins on
...
- Pro: co-locates all Fable-5-derived conduct; RULE-001 already proposes this file.
...
**Alt B: keep in the Fable-5 agent-preset package.**
...
- **create_file / artifacts behavior** — Fable-5 "file creation" exposes outputs as download
...
- 2026-06-18 — Source assessed: `_SOURCE-fable5.md` operational sections
  ...
  9 norms extracted (N1–N9): N2/N3 NEW, N4/N6 NEW(thin), N1/N5 covered-but-reinforced (Fable-5
