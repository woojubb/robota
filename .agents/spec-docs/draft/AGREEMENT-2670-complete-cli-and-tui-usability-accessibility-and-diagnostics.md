...
- current `packages/agent-transport`, `packages/agent-transport-protocol`,
  `packages/agent-transport-tui`, `packages/agent-transport-gui` and their final renamed owners
...
- [ ] BEHAVIOR-2003 — todo — `.agents/tasks/BEHAVIOR-2003-configure-contextual-tui-key-bindings.md`
