...
- This exact AGREEMENT Task/spec and seven new child Tasks.
...
3. **Create one AGREEMENT with seven new cause-aligned children and explicit external dependencies (chosen).**
...
- [ ] TC-01: Observable: the parent Task/spec and all seven child Tasks form one exact-basename, source-cited, lifecycle-open manifest with matching Children/Tasks projections.
- [ ] TC-02: Observable: BEHAVIOR-2664 and DATA-2664 precede governance children, while every declared dependency names an existing non-duplicated Task owner.
...
- [ ] TC-07: Observable: final issue #2664 reconciliation maps all seven children and AGREEMENT-012, AGREEMENT-013, and AGREEMENT-2698 to delivered or explicit terminal evidence before the umbrella receives its closure record.
...
- [ ] RULE-2326 — in-progress — `.agents/tasks/RULE-2326-enforce-rebase-stable-universal-recommendation-endorsement.md`
