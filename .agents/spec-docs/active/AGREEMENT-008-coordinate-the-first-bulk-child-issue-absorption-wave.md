...
- GATE-IMPLEMENT — `.agents/tasks/<ID>.md` has been created: `## Tasks` names `.agents/tasks/AGREEMENT-008-coordinate-the-first-bulk-child-issue-absorption-wave.md`, which exists
- GATE-IMPLEMENT — Tasks file path is recorded in the `## Tasks` section of the spec document: `## Tasks` names `.agents/tasks/AGREEMENT-008-coordinate-the-first-bulk-child-issue-absorption-wave.md`, whose basename is the spec's
...
- GATE-IMPLEMENT — The tasks file includes a `## Test Plan` (or `## Testing` / `## 검증`) section with ≥50 chars — the `test-plans`: Task `## Test Plan` is 532 chars
...
```json
{
  ...
  "deliveryMode": "single",
  "sequencedArtifacts": [],
  "taskPath": ".agents/tasks/AGREEMENT-008-coordinate-the-first-bulk-child-issue-absorption-wave.md",
  "specPath": ".agents/spec-docs/todo/AGREEMENT-008-coordinate-the-first-bulk-child-issue-absorption-wave.md",
  "taskItems": [
    {
      "kind": "tc-id",
      "value": "TC-01"
  ...
  "worktreePaths": [
    ".agents/spec-docs/todo/AGREEMENT-008-coordinate-the-first-bulk-child-issue-absorption-wave.md",
    ".agents/tasks/AGREEMENT-008-coordinate-the-first-bulk-child-issue-absorption-wave.md"
  ]
}
```
