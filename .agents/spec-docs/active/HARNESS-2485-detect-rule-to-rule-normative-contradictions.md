...
scripts/harness/**tests**/scan-rule-contradictions.test.mjs
...
- GATE-IMPLEMENT — ordering: prior approval and status `approved` are recorded in this spec's evidence log.
- GATE-IMPLEMENT — Tasks file path is recorded in `## Tasks` and the exact Task exists.
- GATE-IMPLEMENT — Task Plan covers TC-01 through TC-03 and includes a Test Plan.
- GATE-IMPLEMENT — The exact Task records `SCENARIO DRAFTED: not-applicable | 0` with a product-surface reason.
...
```json
{
  ...
  "taskPath": ".agents/tasks/HARNESS-2485-detect-rule-to-rule-normative-contradictions.md",
  "specPath": ".agents/spec-docs/todo/HARNESS-2485-detect-rule-to-rule-normative-contradictions.md",
  "taskItems": [
    {
      "kind": "tc-id",
      "value": "TC-01"
  ...
  "worktreePaths": [
    ".agents/spec-docs/todo/HARNESS-2485-detect-rule-to-rule-normative-contradictions.md",
    ".agents/tasks/HARNESS-2485-detect-rule-to-rule-normative-contradictions.md"
  ]
}
```
