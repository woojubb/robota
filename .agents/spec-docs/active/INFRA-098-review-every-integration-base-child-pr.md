...
- [ ] TC-05: PR #1724 receives a `github-actions` review on its current base/head pair after the
...
| ----- | ------------------- | -------------------------------------------------------- | ----------------------------------------------------------------------------------------------- |
| TC-01 | CI structure        | parsed workflow fixture tests                            | Include arbitrary slash-containing base names and filter mutations.                             |
| TC-02 | Security contract   | workflow safety scan fixtures                            | Bidirectional permission/token/event/marker assertions.                                         |
| TC-03 | Hook integration    | merge-gate decision/disposition fixtures                 | Exact SHA-pair matrix; timestamp-only verdicts fail.                                            |
| TC-04 | Harness integration | focused Vitest plus `pnpm harness:scan`                  | Zero examined tests/scans must fail closed.                                                     |
...
- [ ] `.agents/tasks/INFRA-098-review-every-integration-base-child-pr.md`
