...
- [ ] `.agents/tasks/MCP-005-project-mcp-tool-schemas-safely-across-providers.md` — existing Task (status `todo`); GATE-IMPLEMENT pairs it with this document
...
- GATE-WRITE — Tasks section present with placeholder: PASS (mechanical) — names `.agents/tasks/MCP-005-project-mcp-tool-schemas-safely-across-providers.md`, which exists at the base with `status: todo`
...
- GATE-IMPLEMENT — `.agents/tasks/<ID>.md` has been created: `## Tasks` names `.agents/tasks/MCP-005-project-mcp-tool-schemas-safely-across-providers.md`, which exists
- GATE-IMPLEMENT — Tasks file path is recorded in the `## Tasks` section of the spec document: `## Tasks` names `.agents/tasks/MCP-005-project-mcp-tool-schemas-safely-across-providers.md`, whose basename is the spec's
