...
- GATE-IMPLEMENT — `.agents/tasks/<ID>.md` has been created: `## Tasks` names `.agents/tasks/AGREEMENT-012-coordinate-strict-metadata-decoder-adoption.md`, which exists
- GATE-IMPLEMENT — Tasks file path is recorded in the `## Tasks` section of the spec document: `## Tasks` names `.agents/tasks/AGREEMENT-012-coordinate-strict-metadata-decoder-adoption.md`, whose basename is the spec's
...
```json
{
  ...
  "deliveryMode": "single",
  "sequencedArtifacts": [],
  "taskPath": ".agents/tasks/AGREEMENT-012-coordinate-strict-metadata-decoder-adoption.md",
  "specPath": ".agents/spec-docs/todo/AGREEMENT-012-coordinate-strict-metadata-decoder-adoption.md",
  "taskItems": [
    {
      "kind": "tc-id",
      "value": "TC-01"
  ...
  "worktreePaths": [
    ".agents/spec-docs/todo/AGREEMENT-012-coordinate-strict-metadata-decoder-adoption.md",
    ".agents/tasks/AGREEMENT-012-coordinate-strict-metadata-decoder-adoption.md"
  ]
}
```
