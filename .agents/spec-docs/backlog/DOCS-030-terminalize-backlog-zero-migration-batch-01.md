...
| ------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| AGREEMENT-001 | `.agents/tasks/AGREEMENT-001-complete-arch-dag-runtime-backlog.md` @ `f86c69b76a190f295f209582726d45c3f0b533cb`; `.agents/spec-docs/active/AGREEMENT-001-complete-arch-dag-runtime-backlog.md` @ `4f1f88833de8fef90d37378c6c1e824935173b7c`                           | This DOCS-030 worktree is the sole migration owner; no competing implementation owner. Exact title `AGREEMENT-001: converge the remaining child outcomes and close the initiative` and marker `backlog-zero:AGREEMENT-001:2c875dd3` will be uniquely read back before approval      | Delivered and unfinished criteria are mapped below. The new issue owns only TC-12 roll-up and final TC-13, depends initially on the still-live DAG-004/RUNTIME-002/RUNTIME-004 Task records, and excludes their implementation. It cannot close until later handoff comments supply each exact child issue URL or terminal delivery evidence. Task `skipped`; spec `rejected`; same handoff URL.                                                                         | standing/spec-user: `active/AGREEMENT-001-complete-arch-dag-runtime-backlog.md` → `rejected/AGREEMENT-001-complete-arch-dag-runtime-backlog.md`                                                                                                                     |
| AGREEMENT-002 | `.agents/tasks/AGREEMENT-002-complete-august-13-agent-architecture-findings.md` @ `63d040e41f5f8d82c79577050804454f9014c244`; `.agents/spec-docs/active/AGREEMENT-002-complete-august-13-agent-architecture-findings.md` @ `6ddd67a331884298fe6a7082c31e624e0e6b81a9` | This DOCS-030 worktree is the sole migration owner; no competing implementation owner. Exact title `AGREEMENT-002: resolve TC-08 credential-boundary evidence and close the initiative` and marker `backlog-zero:AGREEMENT-002:2c875dd3` will be uniquely read back before approval | TC-08 remains ambiguous against current literal-credential fallback and TC-16 remains unfinished. The new issue owns only the owner decision/rescope for TC-08 and final TC-16. Open issue #2047 currently owns generic JSON-safe DTO/framework-type leakage; the stronger credential-absence criterion becomes its remote implementation scope only after this batch's handoff comment is read back before approval. Task `skipped`; spec `rejected`; same handoff URL. | standing/spec-user: `active/AGREEMENT-002-complete-august-13-agent-architecture-findings.md` → `rejected/AGREEMENT-002-complete-august-13-agent-architecture-findings.md`; reference-kind: spec active → rejected at count 5 and Task source → completed at count 1 |
| ARCH-043      | `.agents/tasks/ARCH-043-workspace-access-is-not-a-session-owned-policy.md` @ `09779128335148af55017d708e155bb28a783477`                                                                                                                                               | Exact OPEN issue https://github.com/woojubb/robota/issues/2139; unassigned. This DOCS-030 worktree is the sole migration owner; no competing implementation PR/branch/worktree/session/reservation                                                                                  | All four criteria remain with immutable session-owned workspace policy, transition authority, restricted-mode non-escalation, and shared SDK/CLI composition. Task `skipped` after handoff.                                                                                                                                                                                                                                                                              | none                                                                                                                                                                                                                                                                |
| ARCH-044      | `.agents/tasks/ARCH-044-subagent-child-wire-reuses-live-runtime-contracts.md` @ `73733bb21a1e819958313db1b671e83b462fa3d6`                                                                                                                                            | Exact OPEN issue https://github.com/woojubb/robota/issues/2047; unassigned. This DOCS-030 worktree is the sole migration owner; no competing implementation PR/branch/worktree/session/reservation                                                                                  | JSON-safe DTO ownership, total codec rejection, collaborator exclusion, and field-coverage tests all remain. Task `skipped` after handoff.                                                                                                                                                                                                                                                                                                                               | none                                                                                                                                                                                                                                                                |
| ARCH-045      | `.agents/tasks/ARCH-045-child-provider-credentials-and-destinations-have-separate-owners.md` @ `23cd08986f0b7aee2abac08e7d61666fa831789a`                                                                                                                             | Exact OPEN issue https://github.com/woojubb/robota/issues/2138; unassigned. This DOCS-030 worktree is the sole migration owner; no competing implementation PR/branch/worktree/session/reservation                                                                                  | Atomic credential/destination ownership, effective-source validation, pre-secret mismatch failure, and alternate-endpoint canaries all remain. Task `skipped` after handoff.                                                                                                                                                                                                                                                                                             | none                                                                                                                                                                                                                                                                |
| ARCH-046      | `.agents/tasks/ARCH-046-workspace-contribution-inventory-duplicates-loader-ownership.md` @ `b46ad1e48c0875b144acb3a12b4f8171101b5c62`                                                                                                                                 | Exact OPEN issue https://github.com/woojubb/robota/issues/2140; unassigned. This DOCS-030 worktree is the sole migration owner; no competing implementation PR/branch/worktree/session/reservation                                                                                  | One owner registry, fail-closed source coverage, fixed-depth/no-follow pre-trust inspection, and one category vocabulary all remain. Task `skipped` after handoff.                                                                                                                                                                                                                                                                                                       | none                                                                                                                                                                                                                                                                |
...
1. Commit this manifest, create/read back the two exact convergence issues, append/read back all six
   handoff comments, then replace both pending markers with exact issue/comment URLs before approval.
...
- [ ] TC-02: two unique convergence issues and six append-only handoff comments are read back; each
      unfinished terminal record cites its exact comment URL and preserves decisions/evidence/remaining
