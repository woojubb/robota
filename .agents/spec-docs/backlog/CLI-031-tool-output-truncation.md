...
- [ ] TC-01: 30,000자 초과 도구 출력 → 모델에게 전달되는 메시지에 truncation 알림 포함
- [ ] TC-02: 30,000자 이하 출력 → truncation 알림 없음
- [ ] TC-03: truncation 알림 텍스트가 "출력이 잘렸습니다" 또는 동등한 표현을 포함
...
- [ ] `.agents/tasks/CLI-031.md` — 미생성 (GATE-APPROVAL 통과 후 생성)
