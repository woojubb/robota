...
| ------- | ------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| CLI-082 | `.agents/tasks/CLI-082-output-styles-research.md` @ `d178952d3a03a361e2474b817cbda19b86168d98`                                       | Exact OPEN/unassigned issue #1988. No dedicated output-style surface exists. Current preset/persona, composed-prompt, and live `/preset` seams narrow the old Task statement, but its reference re-read, provider-neutral model, per-line decisions, and reviewer sign-off remain open.                              | Preserve the completed seam research and corrected current seams; retain steps 1, 2, and 4 plus implementation as issue work. Task `skipped`, returned to the exact issue #1988 handoff comment.                              |
| CMD-007 | `.agents/tasks/CMD-007-cost-budget-hardcodes-fs-path-bypassing-settings-port.md` @ `68b69f36f17ad85f1880ea007985772af94e6142`        | Exact OPEN/unassigned issue #2058. Production `session-command.ts` still imports filesystem primitives, owns `.robota/budget.json`, and performs budget persistence inside the reusable command package.                                                                                                             | Preserve the port-ownership, product-path, typed failure, tests, and restart scenario criteria. Task `skipped`, returned to the exact issue #2058 handoff comment.                                                            |
| CMD-008 | `.agents/tasks/CMD-008-sessionrequirements-documented-as-gate-implemented-as-switch.md` @ `67f3d5570e441b71c3013e654ac27c01814a82e5` | The contract still describes a required runtime facility while the sole consumer enables `agent-runtime` when a declaring module is present. No exact open or closed issue, PR, branch, worktree, assignee, or reservation owns the semantic contradiction. Planned marker: `backlog-zero:CMD-008:2c875dd3`.         | Decide demand-switch versus registration-gate semantics, then align the contract, package SPEC, implementation, tests, and any applicable product scenario. Task `skipped`, returned to the exact new issue handoff comment.  |
| CMD-009 | `.agents/tasks/CMD-009-schedule-list-shows-the-pre-edit-instruction.md` @ `270db6474f03cc2e0f6d170bad4c73bd88f411d4`                 | Schedule creation still captures `labelFor('Scheduled', instruction)` in `state.label`; edit updates `agentInstruction` but not the label, and list renders the stale label. No exact open or closed issue, PR, branch, worktree, assignee, or reservation owns it. Planned marker: `backlog-zero:CMD-009:2c875dd3`. | Derive displayed instruction from current state, check sibling rendered fields, add red-first coverage, and verify edit-to-list through the product surface. Task `skipped`, returned to the exact new issue handoff comment. |
...
Control issue marker planned: `backlog-zero:DOCS-033:2c875dd3`. It will own this batch PR only. Parent
