...
- [ ] TC-01: `apps/www/src/components/Header.tsx`에 `docs.robota.io` 링크가 포함됨
- [ ] TC-02: Phase 2 전환 전 체크리스트 항목(www 2주 안정 운영, Google Search Console 인덱싱 확인)이 모두 확인됨
- [ ] TC-03: `robota.io` 접속 시 `www.robota.io`로 301 redirect됨
...
- [ ] `.agents/tasks/SITE-004.md` — 미생성 (GATE-APPROVAL 통과 후 생성)
