...
- [ ] TC-01: `uses: robota-sdk/action@v1` + `task: "Review this PR"` → PR comment 자동 생성
- [ ] TC-02: `api-key: ${{ secrets.ANTHROPIC_API_KEY }}` 파라미터가 CLI에 전달됨
- [ ] TC-03: Action이 GitHub Marketplace에서 검색 가능
- [ ] TC-04: docs에 Quick Start 가이드 페이지 게시
...
- [ ] `.agents/tasks/PM-026.md` — 미생성 (GATE-APPROVAL 통과 후 생성)
