...
- [ ] TC-01: `grep -r "studio-surface\|studio-glow\|studio-grid-bg" apps/agent-web/src/app/globals.css` 결과가 없음 (클래스 정의 삭제됨)
- [ ] TC-02: `grep -n 'style={{' packages/agent-web-ui/spa/main.tsx` 결과가 없음
- [ ] TC-03: `pnpm --filter @robota-sdk/agent-web-ui build` 명령이 오류 없이 완료됨
...
- [ ] `.agents/tasks/FRONTEND-001.md` — 미생성 (GATE-APPROVAL 통과 후 생성)
