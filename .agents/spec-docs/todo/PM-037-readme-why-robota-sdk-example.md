...
- [ ] TC-01: README에 "Why Robota?" 또는 동등한 섹션 제목이 존재하고 경쟁사 비교 표가 포함됨
- [ ] TC-02: README에 `@robota-sdk/agent-framework` import를 사용하는 SDK 임베딩 코드 예제가 포함됨
- [ ] TC-03: SDK 임베딩 예제 코드가 타입체크(`pnpm typecheck`)를 통과함
