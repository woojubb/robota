...
NEXT: SELFHOST-012 P2 (surface + agent-run verification, fold in P3 persistence), then 013 (multi-surface-deployment-gateway), 014 (shared-async-session-artifacts).
