...
| Agent providers and remote execution | `agent-provider`, `agent-remote-client`, `agent-team` (placeholder — no exports), `apps/agent-server`                                                                                                                                                                                                                                                             | [agent-system.md](agent-system.md), [cross-cutting-contracts.md](cross-cutting-contracts.md) |
