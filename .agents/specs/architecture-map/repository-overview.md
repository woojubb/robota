...
| DAG domain and runtime               | `dag-core`, `dag-cost`, `dag-api`, `dag-runtime`, `dag-worker`, `dag-projection`, `dag-orchestrator`, `dag-node*`                | [dag-system.md](dag-system.md)                                                               |
| DAG product shells and services      | `dag-cli`, `dag-mcp-server`, `dag-studio`, `dag-runtime-server`, `dag-orchestrator-server`                                       | [dag-system.md](dag-system.md), [apps-and-deployment.md](apps-and-deployment.md)             |
