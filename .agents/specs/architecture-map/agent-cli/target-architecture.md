...
| CLI → agent-transport                 | Allowed   | CLI uses headless transport (print mode), TuiTransport, TransportRegistry, PrintTerminal, promptInput.           |
