...
| [composition-tree.md](composition-tree.md)                     | `startCli()`, preset selection glue, provider/module composition, TUI hook path, print-mode startup |
| [commands-and-provider-flow.md](commands-and-provider-flow.md) | Built-in command layer, provider setup, profile switching, model catalog flow, and preset selection |
...
- Update the smallest relevant file in this folder when changing CLI composition, commands, providers, models, preset selection glue, execution modes, host adapters, or layer ownership.
