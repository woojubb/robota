...
| **Documentation refresh**                       | `documentation-refresh`                                                                                        | `doc-fixer`                                                   | `doc-auditor` → ACTIONABLE FINDINGS; `finding-depth-triager` → DEPTH                                              | auto → resolved (fixed / contained / invalid), not fixed                                                     | doc-examples, docs-structure, depth-verdict-reachable                                                              |
