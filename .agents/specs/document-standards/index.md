...
| ------------------------ | ------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------- |
| Package `SPEC.md`        | package contract   | `packages/*/docs/SPEC.md`                                                                                                                                                                                                                                   | defined | [`spec-template.md`](../../templates/spec-template.md) / [`spec-writing-standard`](../../skills/spec-writing-standard/SKILL.md) / `harness:scan:specs`                                                                                                             | —                                                                                 |
| Backlog spec-doc         | work item          | `.agents/spec-docs/**`                                                                                                                                                                                                                                      | defined | — / [`backlog-writer`](../../skills/backlog-writer/SKILL.md) / GATE-WRITE..COMPLETE + `spec-doc-frontmatter`                                                                                                                                                       | RULE-011 (done)                                                                   |
...
| Design / LLD             | component-internal | `packages/*/docs/design/` · cross-cutting `.agents/specs/`. **What goes here vs. in the package's `SPEC.md` is decided by the consumer-impact test** ([`design-doc-authoring`](../../skills/design-doc-authoring/SKILL.md) > Placement criterion, RULE-013) | defined | [template](../../templates/design-doc-template.md) / [`design-doc-authoring`](../../skills/design-doc-authoring/SKILL.md) / `design-doc`                                                                                                                           | RULE-009 (done)                                                                   |
...
| Fact catalogue           | harness asset      | `.agents/specs/*.md` (e.g. [`gate-catalogue`](../gate-catalogue.md), [`orchestration-map`](../orchestration-map.md), [`deployment-matrix`](../deployment-matrix.md))                                                                                        | partial | — / [`harness-composition-design`](../harness-composition-design.md) (kind definition) / per-catalogue only (`orchestration-map`, `deployment-matrix`); no shared gate                                                                                             | HARNESS-049 (fourth kind named 2026-07-26; shared shape/coverage guard not built) |
