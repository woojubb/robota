...
| Work design document    | optional work design | `.agents/spec-docs/**`                                                                                                                                                                                                                                    | defined | — / [`backlog-writer`](../../skills/backlog-writer/SKILL.md) / focused review for the actual risk; no lifecycle gate                                                                                                                                               | Historical gate documents remain readable                                        |
...
| Fact catalogue           | harness asset      | `.agents/specs/*.md` (e.g. [`orchestration-map`](../orchestration-map.md), [`deployment-matrix`](../deployment-matrix.md))                                                                                                                             | partial | — / per-catalogue only (`orchestration-map`, `deployment-matrix`); no shared gate                                                                                                                                                                                  | HARNESS-049 (fourth kind named 2026-07-26; shared shape/coverage guard not built) |
