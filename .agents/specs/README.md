...
| [gate-catalogue.md](gate-catalogue.md)                                     | Fact catalogue: every named gate, its criteria, its prior gate, and its evidence format  |
| [orchestration-map.md](orchestration-map.md)                               | Fact catalogue: every orchestrator / worker / guardian pipeline and agent                |
| [deployment-matrix.md](deployment-matrix.md)                               | Fact catalogue: surface × runtime × transport for the one-definition-many-channels story |
