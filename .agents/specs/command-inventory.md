...
| `/schedule`       | `@robota-sdk/agent-command`             | inline    | yes             | `spawnScheduledWake` host-context bridge (cron/one-shot agent wake)    |
| `/monitor`        | `@robota-sdk/agent-command`             | inline    | yes             | `spawnMonitorWake` host-context bridge (process line-match agent wake) |
