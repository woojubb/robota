...
depends_on: []
no-issue: temporary planning anchor for the existing maintainer-authorized workflow
---
...
Record a temporary planning boundary for a repository-governance change.
...
**Reason:** This temporary anchor records repository-maintainer workflow metadata only and exposes no end-user runtime surface, command behavior, SDK contract, or product-facing interaction to execute.
...
The implementation task is this temporary planning anchor itself.
