---
title: 'REMOTE-017: implement node identity and trusted-device repository adapters'
issue: https://github.com/woojubb/robota/issues/2119
status: todo
created: 2026-09-03
priority: high
urgency: soon
area: remote-control identity and trust
depends_on: [REMOTE-016, SEC-020]
---

# REMOTE-017: implement node identity and trusted-device repository adapters

## Objective

Preserve and deliver the independently verifiable outcome of [issue #2119](https://github.com/woojubb/robota/issues/2119) after its redundant child-Issue queue entry is absorbed into the RULE-023 Task graph.
