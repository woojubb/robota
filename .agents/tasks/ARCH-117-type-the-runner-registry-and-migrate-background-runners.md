---
title: 'ARCH-117: type the runner registry and migrate background runners'
issue: https://github.com/woojubb/robota/issues/2101
status: todo
created: 2026-09-03
priority: high
urgency: soon
area: background runner architecture
depends_on: [DATA-010]
---

# ARCH-117: type the runner registry and migrate background runners

## Objective

Preserve and deliver the independently verifiable outcome of [issue #2101](https://github.com/woojubb/robota/issues/2101) after its redundant child-Issue queue entry is absorbed into the RULE-023 Task graph.
