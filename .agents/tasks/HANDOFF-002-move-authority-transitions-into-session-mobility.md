---
title: 'HANDOFF-002: move authority transitions into session mobility'
issue: https://github.com/woojubb/robota/issues/2090
status: todo
created: 2026-09-03
priority: high
urgency: soon
area: session mobility authority
depends_on: [ARCH-100]
---

# HANDOFF-002: move authority transitions into session mobility

## Objective

Preserve and deliver the independently verifiable outcome of [issue #2090](https://github.com/woojubb/robota/issues/2090) after its redundant child-Issue queue entry is absorbed into the RULE-023 Task graph.
