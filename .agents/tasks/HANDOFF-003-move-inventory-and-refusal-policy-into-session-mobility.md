---
title: 'HANDOFF-003: move inventory and refusal policy into session mobility'
issue: https://github.com/woojubb/robota/issues/2106
status: todo
created: 2026-09-03
priority: high
urgency: soon
area: session mobility policy
depends_on: [HANDOFF-002]
---

# HANDOFF-003: move inventory and refusal policy into session mobility

## Objective

Preserve and deliver the independently verifiable outcome of [issue #2106](https://github.com/woojubb/robota/issues/2106) after its redundant child-Issue queue entry is absorbed into the RULE-023 Task graph.
