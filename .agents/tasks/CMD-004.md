...
Status: done — Phase 1 complete (PRs A–I + final deletion #887 merged; TC-01..TC-09 evidence in spec Evidence Log). Phase 2 (WS + web-ui multi-env broadcast) is a separate future track.
