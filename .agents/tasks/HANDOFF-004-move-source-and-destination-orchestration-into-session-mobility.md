---
title: 'HANDOFF-004: move source and destination orchestration into session mobility'
issue: https://github.com/woojubb/robota/issues/2126
status: todo
created: 2026-09-03
priority: high
urgency: soon
area: session mobility orchestration
depends_on: [HANDOFF-003]
---

# HANDOFF-004: move source and destination orchestration into session mobility

## Objective

Preserve and deliver the independently verifiable outcome of [issue #2126](https://github.com/woojubb/robota/issues/2126) after its redundant child-Issue queue entry is absorbed into the RULE-023 Task graph.
