...
priority: critical
urgency: now
area: MCP client and HTTP transport
depends_on: [MCP-001]
---
...
Preserve and deliver the independently verifiable outcome of [issue #2521](https://github.com/woojubb/robota/issues/2521) after its redundant child-Issue queue entry is absorbed into the RULE-023 Task graph.
