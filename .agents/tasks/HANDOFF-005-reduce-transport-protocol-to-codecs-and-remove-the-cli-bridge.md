---
title: 'HANDOFF-005: reduce transport protocol to codecs and remove the CLI bridge'
issue: https://github.com/woojubb/robota/issues/2127
status: todo
created: 2026-09-03
priority: high
urgency: soon
area: handoff protocol boundary
depends_on: [HANDOFF-004]
---

# HANDOFF-005: reduce transport protocol to codecs and remove the CLI bridge

## Objective

Preserve and deliver the independently verifiable outcome of [issue #2127](https://github.com/woojubb/robota/issues/2127) after its redundant child-Issue queue entry is absorbed into the RULE-023 Task graph.
