---
title: 'REMOTE-015: extract the pure remote-control host state reducer'
issue: https://github.com/woojubb/robota/issues/2086
status: todo
created: 2026-09-03
priority: high
urgency: soon
area: remote-control host state
depends_on: []
---

# REMOTE-015: extract the pure remote-control host state reducer

## Objective

Preserve and deliver the independently verifiable outcome of [issue #2086](https://github.com/woojubb/robota/issues/2086) after its redundant child-Issue queue entry is absorbed into the RULE-023 Task graph.
