...
| Issue #2442 | SCREEN-2442        | real Terminal.app/iTerm2 Korean IME evidence and policy decision  |
...
- [ ] OBSERVABILITY-1991 — in-progress — `.agents/tasks/OBSERVABILITY-1991-diagnose-cli-configuration-and-runtime-readiness-before-a-session-starts.md`
...
- [ ] BEHAVIOR-2003 — in-progress — `.agents/tasks/BEHAVIOR-2003-configure-contextual-tui-key-bindings.md`
