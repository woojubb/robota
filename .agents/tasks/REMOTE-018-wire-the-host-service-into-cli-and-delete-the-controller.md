---
title: 'REMOTE-018: wire the host service into CLI and delete the controller'
issue: https://github.com/woojubb/robota/issues/2120
status: todo
created: 2026-09-03
priority: high
urgency: soon
area: remote-control CLI host
depends_on: [REMOTE-017]
---

# REMOTE-018: wire the host service into CLI and delete the controller

## Objective

Preserve and deliver the independently verifiable outcome of [issue #2120](https://github.com/woojubb/robota/issues/2120) after its redundant child-Issue queue entry is absorbed into the RULE-023 Task graph.
