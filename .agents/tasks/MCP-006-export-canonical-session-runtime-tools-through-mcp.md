---
title: 'MCP-006: export canonical session runtime tools through MCP'
issue: https://github.com/woojubb/robota/issues/2530
status: todo
created: 2026-09-03
priority: critical
urgency: now
area: MCP server tools
depends_on: []
---

# MCP-006: export canonical session runtime tools through MCP

## Objective

Preserve and deliver the independently verifiable outcome of [issue #2530](https://github.com/woojubb/robota/issues/2530) after its redundant child-Issue queue entry is absorbed into the RULE-023 Task graph.
