...
depends_on:
  - INFRA-BL-008
blocked-by: tsdown 1.0 미출시 및 package exports 출력 계약 전환 리스크
---
...
- 현재 repo의 build output contract guard는 76개 패키지에서 통과한다.
...
- npm `tsdown`: `0.22.0`, modified `2026-05-07T10:07:41.776Z`
