...
- [x] Add the claim extractor/comparator and register the fail-closed scan.
- [x] Add red-proof and regression tests for weaker, negated and suppressed pairs.
- [x] Run the affected scan/test gate and archive the Task with the paired spec.
