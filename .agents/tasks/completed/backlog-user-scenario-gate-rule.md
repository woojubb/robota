...
2. Update `.agents/skills/backlog-execution-orchestrator/SKILL.md` to enforce the user execution
   test scenario gate.
3. Update `.agents/tasks/README.md` so backlog authors know to include `## Test Plan` and
...
- Verification commands:
  ...
  ```bash
  rg -n "## User Execution Test Scenarios|exact command lines or UI steps|Static review is not enough" .agents/tasks/README.md
