...
3. Update `.agents/tasks/README.md` with the concrete scenario requirement.
...
- Verification commands:
  ...
  rg -n "^## User Execution Test Scenarios" .agents/tasks/cli-ai-workflow-reviewer-harness-planning.md .agents/tasks/completed/*.md
  ```
