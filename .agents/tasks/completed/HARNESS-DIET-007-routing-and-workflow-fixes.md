...
priority: medium
urgency: soon
area: AGENTS.md, .agents/tasks/README.md, .agents/skills/index.md, .agents/specs/document-standards, .github/workflows
depends_on: []
---
...
- **`.agents/tasks/README.md`** (766 lines) → delete the inline `## Items` ledger (~676 lines): it inlines
