...
- Evidence: 2026-06-12 — the CLI-074 deterministic PTY harness (node-pty, per-key paced
  ...
  (`packages/agent-transport-tui/src/__tests__/pty/tui-pty.ptytest.ts`). <!-- evidence-superseded: STRUCT-012 S4 renamed this historical source path to packages/agent-ui-terminal/src/__tests__/pty/tui-pty.ptytest.ts. --> The original
