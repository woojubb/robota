...
`backlog-execution-orchestrator` skill owns sequencing and reporting only. `.agents/tasks/README.md`
...
3. Update `.agents/tasks/README.md` so future backlog entries require the same fields.
...
- Verification commands:
  ...
  rg -n "completed code path or delivered artifact|product-surface scenarios|rg`, harness commands|must not invent a user execution test scenario" .agents/tasks/README.md
  ```
...
- Evidence:
  ...
  - `rg` against `.agents/tasks/README.md` printed lines 19, 25, 32, and 36, covering
