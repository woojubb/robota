...
| Process         | [process.md](process.md)                 | Routing file → spec-workflow, tdd-and-planning, verification, publish, operational |
...
| Common Mistakes | [common-mistakes.md](common-mistakes.md) | 29 observed failure patterns with correct approaches                               |
