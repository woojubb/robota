...
| `@robota-sdk/agent-file-authority`             | beta    | Stable root-relative bounded file-read authority backed by retained native handles on Linux, macOS, and Windows                                                    |
...
| `@robota-sdk/agent-transport`                  | beta    | Transport-neutral session bridge, wire protocol, codecs, and delivery helpers for the Robota SDK                                                                   |
