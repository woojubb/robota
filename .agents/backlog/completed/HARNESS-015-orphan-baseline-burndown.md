...
| `packages/agent-provider/src/anthropic/message-converter.ts`                                                     | `convertFromAnthropicResponse`          | DELETE (declaration referenced nowhere)                                     |
| `packages/agent-provider/src/gemma/pseudo-command-envelope.ts`                                                   | `parseGemmaPseudoCommandEnvelope`       | REMOVE-EXPORT (used only within its own file)                               |
