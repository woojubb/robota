...
**증거 필드**: 모든 unit test 통과 (agent-runtime: 67 tests, agent-sdk: 757 tests, agent-cli: 142 tests). pnpm typecheck 0 errors, pnpm lint 0 errors. provider-factory 함수들이 각 패키지 index.ts에서 올바르게 export됨 확인.
