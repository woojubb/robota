...
- [ ] TC-01: `.agents/skills/design-quality-audit/SKILL.md` 생성 — 감사 축, 심각도 분류,
      백로그 매핑 절차 포함
- [ ] TC-02: conformance 감사와의 구분(다루는/안 다루는 범위)이 명시됨
- [ ] TC-03: `.agents/skills/index.md`에 등재
- [ ] TC-04: harness-governance 규칙-스킬 일관성 검사 + `pnpm harness:scan` 통과
...
- [ ] SKILL.md 작성 → index.md 등재 → harness:scan 검증
