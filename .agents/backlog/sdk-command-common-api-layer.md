...
- [ ] Define context usage read APIs that `/context` and auto-compact descriptors can consume.
- [ ] Define compact execution APIs with lifecycle metadata that drives normal blocking command state.
