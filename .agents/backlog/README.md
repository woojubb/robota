...
| [PLG-002](PLG-002-playground-agent-sdk-refactor.md)      | agent-web-ui 신규 — CLI 세션 브라우저 모니터 (Phase 1) + 양방향 제어 (Phase 2) | medium   |
...
| [ARCH-FIX-009](ARCH-FIX-009-agent-web-pkg-spec-registration.md)           | agent-web-ui SPEC.md 작성 및 project-structure 등재                                                       | high     |
...
전부 구현 완료 (2026-06-16). api-reference는 retire 채택.
