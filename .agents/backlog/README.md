...
| ID                                                             | 제목                                                                               | 우선순위 |
| -------------------------------------------------------------- | ---------------------------------------------------------------------------------- | -------- |
| [DQ-AUDIT-001](DQ-AUDIT-001-rule-violation-cleanup.md)         | 규칙 위반 정리 — core 벤더 디폴트 리터럴(DQ-02) + deprecated 죽은 메서드(DQ-03)    | high     |
| [DQ-AUDIT-002](DQ-AUDIT-002-ssot-consolidation.md)             | SSOT 통합 — 가격(DQ-04)/토큰추정(DQ-09)/컨텍스트 타입(DQ-10)/re-export(DQ-12)      | high     |
