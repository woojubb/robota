...
녹여 재발을 방지하는 항목. 각 항목은 한 건의 신규/업데이트 스킬 작업에 대응.

| ID                                                          | 제목                                                                        | 우선순위 |
| ----------------------------------------------------------- | --------------------------------------------------------------------------- | -------- |
| [LESSON-001](LESSON-001-live-seam-cold-state-testing.md)    | 라이브 상태변경 seam의 cold-state 테스트 — mock-the-buggy-collaborator 방지 | high     |
| [LESSON-002](LESSON-002-design-quality-audit-skill.md)      | 설계 품질 심층 감사 스킬 신설 — conformance 감사와 분리                     | high     |
| [LESSON-003](LESSON-003-protected-branch-commit-guard.md)   | branch-guard를 commit 단계까지 확장 — 보호 브랜치 직접 커밋 차단            | high     |
| [LESSON-004](LESSON-004-release-publish-runbook.md)         | version-management 스킬에 릴리즈/배포 런북 보강                             | medium   |
| [LESSON-005](LESSON-005-evals-churn-and-stash-hygiene.md)   | evals lessons pre-push churn 자동 처리 + stash 위생                         | medium   |
| [LESSON-006](LESSON-006-post-relocation-reference-sweep.md) | 패키지 재배치 시 다운스트림 참조 일괄 검사 — stale 경로 기계적 탐지         | medium   |
