...
| [finding-depth-triager](../../.claude/agents/finding-depth-triager.md)      | Guardian for the depth verdict: judges a review finding LOCAL / FOUNDATIONAL / INVALID and emits `DEPTH:` — judges only, never fixes or files |
