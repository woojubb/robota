...
description: Execute one backlog item end to end; use `multi-backlog-initiative` when several items share one initiative.
...
## Ordered conversion-to-implementation handoff (PROC-017)
