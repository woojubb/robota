...
- [x] T7: wrap-up — typecheck/lint/build green; PR to develop (squash); backlog
      `.agents/tasks/CLI-B11-*.md` User Execution Test Scenario evidence recorded and file
      moved to completed/.
...
`.agents/tasks/completed/CLI-B11-session-switch-context-restoration-tests.md`.
