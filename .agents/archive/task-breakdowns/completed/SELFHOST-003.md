...
- [x] ENDORSE non-blocking follow-up filed: [`.agents/tasks/HARNESS-027-agent-tools-neutrality-floor.md`](../backlog/HARNESS-027-agent-tools-neutrality-floor.md) (mechanical agent-tools neutrality/dep-allowlist floor — TC-04 no longer rests on the manual grep alone).
...
[`.agents/tasks/SELFHOST-003-P4-embedding-vector-backend.md`](../backlog/SELFHOST-003-P4-embedding-vector-backend.md).
