...
npm install @robota-sdk/agent-core @robota-sdk/agent-provider-openai openai
```
...
<html>
  <head>
    ...
    <script type="module">
      import { Robota, LoggingPlugin } from 'https://cdn.skypack.dev/@robota-sdk/agent-core';
      import { OpenAIProvider } from 'https://cdn.skypack.dev/@robota-sdk/agent-provider-openai';
  ...
  <body>
    ...
    <button onclick="chat(document.getElementById('message').value)">Send</button>
    <button onclick="chatStream(document.getElementById('message').value)">Stream</button>
