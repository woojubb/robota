...
agent-transport-gui        ─→ agent-interface-{command,execution,session,transport}, agent-transport
agent-transport-webrtc-web ─→ agent-transport-gui, agent-remote-pairing, agent-transport
