...
| `chat-input`         | `submit`: `enter`; `history-previous`: `up`; `history-next`: `down`; `cursor-left`: `left`; `cursor-right`: `right`; `delete-backward`: `backspace`, `delete`; `delete-word`: `ctrl+w`; `delete-line`: `ctrl+u` |
