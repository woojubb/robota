...
| [`@robota-sdk/agent-command`](./packages/agent-command/)                     | Consolidated slash command package — all 25 command modules (`/agent`, `/help`, `/provider`, `/skills`, `/plugin`, `/model`, `/mode`, and more)                                                                                                                           |
