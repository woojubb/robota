...
agent-provider-*       ← AI provider clients, one package per vendor (anthropic, openai, openai-compatible, gemini, bytedance)
agent-builtin-providers ← Built-in provider definitions and default role-to-model mapping
  ↓
...
| [`@robota-sdk/agent-command`](./packages/agent-command/)                                       | Consolidated slash command package — all 25 command modules (`/agent`, `/help`, `/provider`, `/skills`, `/plugin`, `/compact`, `/mode`, and more)                                                                                                                                       |
| [`@robota-sdk/agent-provider-anthropic`](./packages/agent-provider-anthropic/)                 | Anthropic (Claude) provider client                                                                                                                                                                                                                                                      |
| [`@robota-sdk/agent-provider-openai`](./packages/agent-provider-openai/)                       | OpenAI provider client                                                                                                                                                                                                                                                                  |
| [`@robota-sdk/agent-provider-openai-compatible`](./packages/agent-provider-openai-compatible/) | OpenAI-compatible provider clients (DeepSeek, Qwen, Gemma)                                                                                                                                                                                                                              |
| [`@robota-sdk/agent-provider-gemini`](./packages/agent-provider-gemini/)                       | Gemini / Google provider client                                                                                                                                                                                                                                                         |
| [`@robota-sdk/agent-provider-bytedance`](./packages/agent-provider-bytedance/)                 | ByteDance (ModelArk) video generation provider client                                                                                                                                                                                                                                   |
| [`@robota-sdk/agent-builtin-providers`](./packages/agent-builtin-providers/)                   | Built-in provider definitions and the default role-to-model mapping                                                                                                                                                                                                                     |
| [`@robota-sdk/agent-cli`](./packages/agent-cli/)                                               | Interactive terminal AI coding assistant                                                                                                                                                                                                                                                |
| [`@robota-sdk/agent-transport`](./packages/agent-transport/)                                   | Browser-safe protocol and delivery substrate with browser decoders at `/client` and Node-only admission/integrity helpers at `/node`. Carrier transports remain standalone packages: `agent-transport-http`, `agent-transport-ws`, `agent-transport-mcp`, and `agent-transport-webrtc`. |
