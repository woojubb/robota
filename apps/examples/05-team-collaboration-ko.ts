...
task_coordinator 템플릿이 최적화된 설정으로 팀 협업을 자동으로 처리합니다.
        ...
        console.log(chalk.green('✅ 예제 1 건너뛰기 - 테스트를 위해 예제 2만 실행합니다...'));
        ...
        const openaiProvider2 = new OpenAIProvider({ apiKey });
...
• 총 실행 시간: ${stats2.totalExecutionTime}ms
        ...
        console.log(chalk.blue(`
📊 전체 요약:
• 총 완료된 작업: ${stats2.tasksCompleted}
• 총 생성된 에이전트: ${stats2.totalAgentsCreated}
• 총 실행 시간: ${stats2.totalExecutionTime}ms
        `));
        ...
        console.log(chalk.blue(`\n📋 Team 2 생성된 노드 수: ${team2Nodes.length}`));
