...
export const ToolRegistry: Record<string, (eventService: any) => FunctionTool> = {
    assignTask: (eventService: any) => createAssignTaskRelayTool(eventService),
    'current-time': (_eventService: any) => createCurrentTimeTool()
};
