...
4. A slash command or skill added or changed without the model-facing description and tested model-invocation
   choice that AGENTS.md requires is a SHOULD.
