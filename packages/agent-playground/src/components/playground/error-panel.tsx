    ...
    <div className="space-y-4">
      ...
      <Card>
        <CardHeader className="pb-3">
          ...
          <CardDescription>
            Found {errors.length} error{errors.length !== 1 ? 's' : ''} and {warnings.length}{' '}
        ...
        <div className="space-y-3">
          {allIssues.map((issue, index) => {
            ...
            return (
              ...
              >
                <Collapsible>
                  <CollapsibleTrigger className="w-full" onClick={() => toggleExpanded(index)}>
                    <CardHeader className="pb-2 hover:bg-muted/50 transition-colors">
                      <div className="flex items-start space-x-3">
                        <SeverityIcon
                          className={`w-5 h-5 mt-0.5 ${severityConfig[issue.severity].color}`}
                        />
                    ...
                    <CardContent className="pt-0 space-y-4">
                      ...
                      <div>
                        ...
                        <div className="space-y-2">
                          {(issue.suggestions || getCommonFixes(issue)).map(
                      ...
                      <div>
                        ...
                        <Button
                          ...
                          variant="outline"
                          onClick={() =>
                            copyToClipboard(generateDebugInfo(issue), `debug-${index}`)
                          }
                          className="flex items-center space-x-2"
                        >
