...
import { BarChart3, Activity, Zap, AlertTriangle, Clock, Users, Settings } from 'lucide-react';
import type {
  IBlockMessage,
 ...
 */
const BlockTypeBreakdown: React.FC<{ blockCollector: IPlaygroundBlockCollector }> = ({
  blockCollector,
}) => {
  const [stats, setStats] = useState(blockCollector.getStats());
