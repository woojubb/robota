  ...
  <div className="flex items-center space-x-1">
    {keyCombo.map((key, index) => (
      <React.Fragment key={index}>
        ...
        {index < keyCombo.length - 1 && <span className="text-muted-foreground text-xs">+</span>}
      </React.Fragment>
    ))}
  </div>
);
        ...
        <ScrollArea className="h-[600px] pr-4">
          <div className="space-y-6">
            {Object.entries(groupedShortcuts).map(([category, categoryShortcuts]) => {
              ...
              const categoryColor =
                categories[category as keyof typeof categories]?.color || 'bg-gray-500';
                ...
                <Card key={category}>
                  <CardHeader className="pb-3">
                    <CardTitle className="flex items-center space-x-2 text-lg">
                      <div
                        className={`w-8 h-8 rounded-lg ${categoryColor} flex items-center justify-center`}
                      >
                ...
                <div className="space-y-3 text-sm text-muted-foreground">
                  <div className="flex items-start space-x-2">
                    ...
                    <p>
                      ...
                      anytime to open this shortcuts dialog
                    </p>
                  </div>
                  <div className="flex items-start space-x-2">
                    ...
                    <p>
                      ...
                      in the code editor for quick execution
                    </p>
                  </div>
                  <div className="flex items-start space-x-2">
                  ...
                  <div className="flex items-start space-x-2">
                    ...
                    <p>
                      ...
                      to quickly close dialogs and return to coding
                    </p>
                  </div>
                </div>
              </CardContent>
