...
export function AgentConfigurationBlock({
  ...
  const handleConfigUpdate = useCallback(
    (updates: Partial<IPlaygroundAgentConfig>) => {
      ...
      <CardContent className="pt-0">
        <Tabs defaultValue="model" className="w-full">
          ...
          <TabsContent value="model" className="space-y-3 mt-3">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                ...
                <span className="text-xs text-gray-500">
                  {editedConfig.defaultModel.temperature || DEFAULT_TEMPERATURE}
                </span>
              </div>
              <input
                type="range"
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                ...
                <span className="text-xs text-gray-500">
                  {editedConfig.defaultModel.maxTokens || DEFAULT_MAX_TOKENS}
                </span>
              </div>
              <input
                type="range"
          ...
          <TabsContent value="tools" className="space-y-3 mt-3">
            <div className="space-y-2">
              <Label className="text-xs font-medium">
                Available Tools ({(editedConfig.tools || []).length})
              </Label>
          ...
          <TabsContent value="plugins" className="space-y-3 mt-3">
            <div className="space-y-2">
              <Label className="text-xs font-medium">
                Active Plugins ({(editedConfig.plugins || []).length})
              </Label>
              <div className="space-y-2 max-h-32 overflow-y-auto">
