/**
 * Core executor types and interfaces for AI provider execution abstraction
 * 
 * Note: These types should be kept synchronized with @robota-sdk/agents types
 * to ensure compatibility when used with actual providers.
 */

// Type definitions that should match @robota-sdk/agents
...
export interface AssistantMessage extends UniversalMessage {
    role: 'assistant';
}
