...
The module consumes `@robota-sdk/agent-framework` command contracts and session command APIs. Hosts compose it by default and apply any typed effects through their own UI or process adapters.
