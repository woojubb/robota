...
export interface IDagOrchestrationCostMetaDeleteSuccessPayload extends IDagOrchestrationHttpPayload {
  readonly ok: true;
  readonly status: number;
  readonly data: IDagOrchestrationCostMetaDeleteData;
}

export interface IDagOrchestrationCostMetaValidationSuccessPayload extends IDagOrchestrationHttpPayload {
  readonly ok: true;
  readonly status: number;
  readonly data: IDagOrchestrationCostMetaValidationData;
}

export interface IDagOrchestrationCostMetaPreviewSuccessPayload extends IDagOrchestrationHttpPayload {
  readonly ok: true;
  readonly status: number;
...
export interface IDagOrchestrationPublishedWorkflowRunSuccessPayload extends IDagOrchestrationHttpPayload {
  readonly ok: true;
  readonly status: number;
