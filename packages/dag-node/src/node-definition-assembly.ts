 ...
 */
export function buildNodeDefinitionAssembly(
  ...
  for (const nodeDefinition of nodeDefinitions) {
    ...
    const manifest: INodeManifest = {
      ...
      ...(nodeDefinition.defaultInputPort !== undefined
        ? { defaultInputPort: nodeDefinition.defaultInputPort }
        : {}),
      ...(nodeDefinition.defaultOutputPort !== undefined
        ? { defaultOutputPort: nodeDefinition.defaultOutputPort }
        : {}),
    };
