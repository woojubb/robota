...
/** @internal */
export function createUserMessageStatic(
  content: string,
...
/** @internal */
export function createAssistantMessageStatic(
...
/** @internal */
export function createSystemMessageStatic(
  content: string,
  metadata?: Record<string, string | number | boolean>,
): ISystemMessage {
  return {
...
/** @internal */
export function createToolMessageStatic(
  toolCallId: string,
...
export function convertToProviderMetadata(
...
export function processStreamingChunk(chunk: {
  delta?: string;
  done?: boolean;
  toolCalls?: IToolCall[];
