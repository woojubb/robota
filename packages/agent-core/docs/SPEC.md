...
| `path`    | `*` within a segment; `**` gitignore-style (`a/**` also matches `a`, `a/**/b` also `a/b`)     | `\` → `/`, then `path.posix.normalize` on both sides; `/…` and `X:/…` are absolute                                                                                                                                                                                                        | a relative argument under an absolute pattern                                                                                                                                                                                                                                                                                              |
