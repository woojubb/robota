...
import { createAssignTaskTool, AssignTaskConfig } from './assign-task/index.js';
...
export class TeamContainer {
    ...
    private assignTaskConfig: AssignTaskConfig; // Configuration for assignTask
    constructor(options: TeamContainerOptions) {
        ...
        this.eventService = options.eventService || DEFAULT_ABSTRACT_EVENT_SERVICE; // Initialize EventService

        // Initialize built-in templates
        this.availableTemplates = this.getBuiltinTemplates();

        // Initialize AssignTask configuration
        this.assignTaskConfig = {
            availableTemplates: this.availableTemplates,
            baseRobotaOptions: this.options.baseRobotaOptions,
        ...
        // Create AssignTaskTool with configuration
        const assignTaskTool = createAssignTaskTool(this.assignTaskConfig);
