/**
 * assign-task-basic example for @robota-sdk/team.
 *
...
async function main(): Promise<void> {
    const listParams = {};
    const listContext: IToolExecutionContext = { toolName: 'listTemplates', parameters: listParams, executionId: 'example_listTemplates' };
