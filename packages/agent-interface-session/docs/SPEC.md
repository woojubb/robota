...
- **Dependency position**: Layer 1. The package manifest declares `agent-core` plus `agent-interface-analytics`, `agent-interface-command`, and `agent-interface-execution`.
