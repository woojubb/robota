...
| ----------------------------------- | -------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `createDefaultCommandModules`       | function | Assembles all 30 standard command modules; returns `{ modules, unknownModuleNames }`                                                                                                |
