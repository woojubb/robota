...
This package is a building block. End-user provider packages such as `agent-provider-openai` and `agent-provider-gemma` compose it and own their product or model-family semantics.
