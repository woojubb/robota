...
- 2916d00: **PROV-004: the OpenAI-compatible siblings build their request through one seam.**
...
- 7669851: Send `response_format` on the OpenAI-compatible request when the resolved model declares the
