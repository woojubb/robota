...
| `TCompactTrigger`                | Type                 | Discriminator for what triggered a compaction (e.g. auto vs manual) — SSOT in `@robota-sdk/agent-interface-transport` (INFRA-025); this package imports it and does not re-export it |
