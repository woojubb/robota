...
evidence, with a validated tool-call correlation ID only in live child projections, not a final turn
settlement, cost total, detached-work completion, or collector receipt.
