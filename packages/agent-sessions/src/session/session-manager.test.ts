...
describe('SessionManager', () => {
  ...
  describe('Session Management', () => {
    ...
    it('should enforce session limits by throwing error', () => {
      ...
      expect(() => {
        ...
        'Maximum sessions limit (5) reached. Please remove existing sessions before creating new ones.',
      );
  ...
  describe('Chat Management', () => {
    ...
    it('should handle non-existent session', async () => {
      ...
      await expect(sessionManager.createChat('non-existent-session', chatOptions)).rejects.toThrow(
