...
import type { IModuleCapabilities, IModuleDescriptor, IModuleExecutionContext, IModuleExecutionResult } from './abstract-module';
...
class TestModule extends AbstractModule {
    ...
    protected override async onExecute(context: IModuleExecutionContext): Promise<IModuleExecutionResult> {
...
describe('AbstractModule', () => {
    ...
    describe('execute', () => {
        ...
        it('emits execution events with eventEmitter', async () => {
            ...
            await module.execute({ executionId: 'e1', sessionId: 's1', userId: 'u1', agentName: 'agent' });
            expect(emitter.emit).toHaveBeenCalled();
        });
    });
