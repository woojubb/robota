 ...
 */
export interface ReactFlowNodeData extends GenericConfig {
    label: string;
    description?: string;
    icon?: string;
    toolName?: string;
 ...
 */
export interface ReactFlowEdgeData extends GenericConfig {
    label?: string;
    description?: string;
 ...
 */
export interface ReactFlowThemeConfig extends GenericConfig {
 ...
 */
export interface ReactFlowNodeStyle extends Record<string, primitive> {
 ...
 */
export interface ReactFlowEdgeStyle extends Record<string, primitive> {
    stroke?: string;
    strokeWidth?: number;
 ...
 */
export interface ReactFlowConverterConfig extends GenericConfig {
    // Layout settings
    nodeSpacing?: {
        horizontal: number;
        vertical: number;
 ...
 */
export interface ReactFlowLayoutConfig extends GenericConfig {
 ...
 */
export interface ReactFlowConversionMetadata extends GenericMetadata {
