...
import { isDefaultEventService, bindWithOwnerPath } from '@robota-sdk/event-service';
...
export class ExecutionEventEmitter {
  ...
  buildBaseOwnerPath(executionContext?: IExecutionContextInjection): IOwnerPathSegment[] {
