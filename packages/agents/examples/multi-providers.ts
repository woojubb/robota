/**
 * Multi-provider example for @robota-sdk/agents.
 *
 * Requirements:
 * - OPENAI_API_KEY
 */
...
async function main(): Promise<void> {
    ...
    await testProvider('OpenAI GPT-3.5', robota35, 'Tell me about artificial intelligence in 2-3 sentences.');
    ...
    await testProvider('OpenAI GPT-4o-mini', robota4Mini, 'Tell me about artificial intelligence in 2-3 sentences.');
