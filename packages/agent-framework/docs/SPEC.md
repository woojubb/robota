...
| `TDecodedFrontmatter` / `IDecodedSkillFrontmatter` / `IDecodedAgentFrontmatter`     | `@robota-sdk/agent-interface-command` (SSOT; SECURITY-002)                                             | Strictly decoded, explicitly discriminated skill/agent metadata variants                                                |
| `IFrontmatterDecodeOptions` / `IFrontmatterDiagnostic` / `TFrontmatterDecodeResult` | `@robota-sdk/agent-interface-command` (SSOT; SECURITY-002)                                             | Decoder input and non-partial source/line/field diagnostics                                                             |
...
| `decodeSkillAgentFrontmatter`                | function | Strict, explicit-kind decoder returning a fully typed skill/agent metadata variant or located diagnostics; it does not migrate loaders                                                                                                                                                                                                                                                                                                        |
