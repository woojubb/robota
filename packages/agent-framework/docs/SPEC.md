...
| `ICommandHostAdapters`                                                | `src/command-api/host-adapters.ts`                                                                     | Host-provided adapter bag, including the optional secret-free MCP activation lifecycle port                             |
