...
| `IModelEffortResolution`                                              | `src/effort/effort-resolution.ts`                                                                      | Provider-neutral requested/effective effort result with source, disposition, and model default                                           |
...
| `IModelEffortResolution`                     | interface | Provider-neutral effort result projected to commands and headless output                                                                                                                                                                                                                                                                                                                                                                      |
...
| `TEffortSelection`                           | type      | User selection union: `auto` or a concrete `TModelEffort` tier                                                                                                                                                                                                                                                                                                                                                                                |
...
| `resolveModelEffort`                         | function  | Resolves command, flag, environment, settings, preset, and model-default inputs into one effective outcome                                                                                                                                                                                                                                                                                                                                    |
