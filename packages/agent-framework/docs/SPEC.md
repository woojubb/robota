...
| `BundlePluginLoader.inspectPluginsSync`      | method    | OBSERVABILITY-1991: discover and classify every plugin (loaded / skipped with reason); `loadPluginsSync()` is its `loaded` projection and logs the skips as before; `hooks/hooks.json` is validated through `HooksSchema` report-only                                                                                                                                                                                                         |
...
| `IBundlePluginMcpFault`                      | type      | OBSERVABILITY-1991: a structurally unusable plugin `.mcp.json`                                                                                                                                                                                                                                                                                                                                                                                |
