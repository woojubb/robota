...
| `createDefaultRemoteCommandPolicy`          | function | Build the deny-by-default `IRemoteCommandPolicy` for remote-origin commands (read-only allowed + optional allowlist; REMOTE-003)                                               |
