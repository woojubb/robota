 ...
 * (bounded concurrency + aggregation) and `handoff` (control-transfer);
 * `hierarchical`/`group-chat` (P3) follow. The framework NEVER depends on
 * `agent-subagent-runner` (that would be a cycle); the concrete runner is
