...
import type { IToolSchema, TToolExecutor, ILogger, TUniversalValue } from '@robota-sdk/agents';
...
export class UniversalToolFactory {
  ...
  createFunctionTool(
    ...
    // Note: FunctionTool no longer accepts a logger option; logging is handled externally.
