# agent-transport-ws Docs Index

`@robota-sdk/agent-transport-ws` exposes `InteractiveSession` over WebSocket.
...
- `SPEC.md`: Package scope, ownership boundaries, and canonical API surface.
