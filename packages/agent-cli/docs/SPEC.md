...
submit a prompt. The global supervised view observes only that guarded inventory: it does not join
peer or saved-record identities, expose content or unverified project paths, or treat an exited
