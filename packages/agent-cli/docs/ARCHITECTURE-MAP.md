...
| `createSkillsCommandModule()`    | `agent-command-skills/src/skills-command-module.ts`         | Command module             | CLI composition, tests                      | agent-sdk command/skill common APIs                                  | Own `/skills`; model route is `ExecuteCommand(command: "skills")`; virtual skills normalize through SDK. |
