...
- Implements `AbstractAIProvider` from `@robota-sdk/agents` to provide Gemini model access through the Google Generative AI SDK.
- Implements `IImageGenerationProvider` from `@robota-sdk/agents` to provide image generation, editing, and composition capabilities.
...
- Does not own `TUniversalMessage`, `IChatOptions`, `IToolSchema`, `IAssistantMessage`, `IUserMessage`, `ISystemMessage`, `IToolMessage`, `TUniversalMessagePart`, or image generation interfaces; imports them from `@robota-sdk/agents`.
...
Dependency direction: `@robota-sdk/google` depends on `@robota-sdk/agents` (peer dependency) and `@google/generative-ai` (direct dependency). No other workspace packages are imported.

## Type Ownership

| Type | Owner | Location |
|------|-------|----------|
| `IGoogleProviderOptions` | `@robota-sdk/google` | `src/types.ts` |
| `TGoogleProviderOptionValue` | `@robota-sdk/google` | `src/types.ts` |
| `IGoogleModelConfig` | `@robota-sdk/google` | `src/types/api-types.ts` |
| `IGoogleGenerateContentRequest` | `@robota-sdk/google` | `src/types/api-types.ts` |
| `IGoogleStreamGenerateContentRequest` | `@robota-sdk/google` | `src/types/api-types.ts` |
| `IGoogleContent` | `@robota-sdk/google` | `src/types/api-types.ts` |
| `IGooglePart` | `@robota-sdk/google` | `src/types/api-types.ts` |
| `IGoogleFunctionCall` | `@robota-sdk/google` | `src/types/api-types.ts` |
| `IGoogleFunctionResponse` | `@robota-sdk/google` | `src/types/api-types.ts` |
| `IGoogleTool` | `@robota-sdk/google` | `src/types/api-types.ts` |
| `IGoogleFunctionDeclaration` | `@robota-sdk/google` | `src/types/api-types.ts` |
| `IGoogleFunctionParameters` | `@robota-sdk/google` | `src/types/api-types.ts` |
| `IGooglePropertySchema` | `@robota-sdk/google` | `src/types/api-types.ts` |
| `IGoogleGenerateContentResponse` | `@robota-sdk/google` | `src/types/api-types.ts` |
| `IGoogleCandidate` | `@robota-sdk/google` | `src/types/api-types.ts` |
| `TGoogleFinishReason` | `@robota-sdk/google` | `src/types/api-types.ts` |
| `IGoogleSafetyRating` | `@robota-sdk/google` | `src/types/api-types.ts` |
| `TGoogleHarmCategory` | `@robota-sdk/google` | `src/types/api-types.ts` |
| `TGoogleHarmProbability` | `@robota-sdk/google` | `src/types/api-types.ts` |
| `IGoogleCitationMetadata` | `@robota-sdk/google` | `src/types/api-types.ts` |
| `IGoogleCitationSource` | `@robota-sdk/google` | `src/types/api-types.ts` |
| `IGooglePromptFeedback` | `@robota-sdk/google` | `src/types/api-types.ts` |
| `TGoogleBlockReason` | `@robota-sdk/google` | `src/types/api-types.ts` |
| `IGoogleUsageMetadata` | `@robota-sdk/google` | `src/types/api-types.ts` |
| `IGoogleStreamChunk` | `@robota-sdk/google` | `src/types/api-types.ts` |
| `IGoogleError` | `@robota-sdk/google` | `src/types/api-types.ts` |
| `IGoogleErrorDetail` | `@robota-sdk/google` | `src/types/api-types.ts` |
| `IGoogleLogData` | `@robota-sdk/google` | `src/types/api-types.ts` |
| `IGoogleToolCall` | `@robota-sdk/google` | `src/types/api-types.ts` |
| `IGoogleMessageConversionResult` | `@robota-sdk/google` | `src/types/api-types.ts` |
| `IGoogleStreamContext` | `@robota-sdk/google` | `src/types/api-types.ts` |
| `GoogleProvider` | `@robota-sdk/google` | `src/provider.ts` |

Imported from `@robota-sdk/agents` (not owned): `AbstractAIProvider`, `TUniversalMessage`, `IChatOptions`, `IToolSchema`, `IAssistantMessage`, `IUserMessage`, `ISystemMessage`, `IToolMessage`, `TUniversalMessagePart`, `IImageGenerationProvider`, `IImageGenerationRequest`, `IImageEditRequest`, `IImageComposeRequest`, `IImageGenerationResult`, `IMediaOutputRef`, `TProviderMediaResult`, `IExecutor`, `TProviderOptionValueBase`.
...
- **AbstractAIProvider contract**: New lifecycle or capability methods added to `AbstractAIProvider` in `@robota-sdk/agents` can be overridden in `GoogleProvider`.
