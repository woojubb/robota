...
export function mapInlineImagePartsToMediaOutputs(parts: TUniversalMessagePart[] | undefined): IMediaOutputRef[] {
    if (!parts) {
        return [];
    }
...
export function buildGenerationConfig(
    ...
    options?: { model?: string; temperature?: number; maxTokens?: number; google?: { responseModalities?: Array<'TEXT' | 'IMAGE'> } }
): {
    temperature?: number;
