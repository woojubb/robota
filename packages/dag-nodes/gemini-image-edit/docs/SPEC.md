...
| `DAG_VALIDATION_GEMINI_IMAGE_INPUT_URI_UNREACHABLE`         | Validation | HTTP URI fetch failed, or refused by the shared egress policy (`fetchWithEgressPolicy`, #2026; `reason` in details) |
