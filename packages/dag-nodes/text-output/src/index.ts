 ...
 */
export class TextOutputNodeDefinition extends AbstractNodeDefinition<
  typeof TextOutputConfigSchema
> {
  ...
  protected override async executeWithConfig(
    ...
    io.setOutput('_agentSummary', `Output: ${textInputResult.value.length} chars.`);
    return {
      ok: true,
      value: io.toOutput(),
    };
