...
- **Off:** project and user instruction files, skills, custom commands, agent definitions, external
  presets, plugins, hooks from every settings layer, and MCP servers.
...
- **New framework option:** `skipConfiguredHooks` on interactive and headless sessions.
